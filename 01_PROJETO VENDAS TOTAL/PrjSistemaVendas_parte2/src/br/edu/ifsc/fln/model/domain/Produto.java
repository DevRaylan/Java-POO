...
//    private int id_categoria.; ISSO É UM CRIME CONTRA A POO
    ...
    public Modelo() {
        //qualquer construtor de Modelo vai passar por este método para a a criação de estoque
        this.createEstoque();
    }

    public Modelo(int id, String nome, String descricao, BigDecimal preco) {
        this();
        this.id = id;
        this.nome = nome;
    ...
    public Modelo(int id, String nome, String descricao, BigDecimal preco, Categoria categoria) {
    ...
    private void createEstoque() {
        //associação bidirecional - define o estoque do Modelo
        this.estoque = new Estoque();
        //atribui o Modelo ao estoque
        this.estoque.setModelo(this);
    }    
