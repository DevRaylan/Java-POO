...
CREATE TABLE item_de_os (
   ...
   key fk_item_de_os_ordemservico(id_ordem_servico)

);

-- Assumindo que os IDs de serviços e ordens de serviço existem
INSERT INTO item_de_os (valorServico, observacoes, id_servico, id_ordem_servico) VALUES
